  ...
  ngOnChanges() {
    ...
    public setup() {
      ...
      var svgContainer = this.host.append("svg")
        ...
        var data = [{"food":"JAN","quantity":24},{"food":"FEB","quantity":15},{"food":"MAR","quantity":6},{"food":"APR","quantity":5},{"food":"MAY","quantity":30},{"food":"JUN","quantity":21},{"food":"JUL","quantity":13},{"food":"AUG","quantity":13},{"food":"SEP","quantity":20},{"food":"OCT","quantity":23},
        {"food":"NOV","quantity":15},{"food":"DEC","quantity":53}]
   ...
   */
   ...
   debugger;
     ...
     svgContainer.selectAll(".text")  		
       ...
       .append("text")
       .attr("class","label")
       .attr("x", (function(d) { return xScale(d.food) + xScale.rangeBand() / 4 ; }  ))
