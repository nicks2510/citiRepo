...
@NgModule({
  ...
  declarations: [ DatatableComponent,ChartJSComponent, stackedBarChartcomponent, DoughnutChartComponent, PieDrillDownChartComponent, PieChartComponent, OrderrByPipe ]
})
